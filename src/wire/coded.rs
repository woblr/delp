...
impl<'a> CodedPacket<'a> {
    ...
    pub fn parse(buf: &'a [u8]) -> Result<Self> {
        ...
        let coded_symbol_id = u32::from_be_bytes(buf[after_tsi..after_tsi + 4].try_into().unwrap());
    ...
    pub fn serialise(
        ...
        let ev_words = ev_bytes.len().div_ceil(4) as u8;
        ...
        out.extend(std::iter::repeat_n(0, ev_pad));
